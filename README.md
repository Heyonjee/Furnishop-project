...
## 9. 프로젝트 회고
- 주문테이블 생성 후 주문상세 테이블을 생성하는 과정에서 주문데이터를 Insert 한 후 그에 따라 생성된 키 값을 받아 주문상세 테이블을 생성하는 로직을 설계한 부분이 이번 프로젝트의 가장 큰 핵심이었던 것 같다. 처음 설계한 대로 프로그램이 실행되었고 파이널 프로젝트에도 적용할 수 있을 것 같다.
